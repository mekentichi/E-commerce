...
import '../../../controller/admin/categories/edit_controller.dart';
...
class CategoriesEdit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body:HandlingDataView(statusrequest: controller.statusrequest, widget: GetBuilder<CategoriesEditController>(
